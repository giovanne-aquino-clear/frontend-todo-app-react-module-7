...
const URLdel = 'http://localhost:3003/api/todos/:id'
...
export default class Todo extends Component{
    ...
    handleMarkAsDone(todo) {
        Axios.put(`${URL}`, {...todo, done:true}).then(resp => this.refresh(this.state.description))
    }

    handleMarkAsPending(todo) {
        Axios.put(`${URL}`, {...todo, done:false}).then(resp => this.refresh(this.state.description))
    }
